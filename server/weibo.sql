...
INSERT INTO `comment` (`comment_id`, `comment_weibo_id`, `comment_username`, `comment_content`, `comment_time`)
VALUES (1, 11, 'redsky', '兰彬炎你好', '2019-12-18 21:04:44'),
...
INSERT INTO `myblog` (`weibo_id`, `weibo_username`, `weibo_content`, `weibo_img`, `weibo_time`)
VALUES (1, 'redsky', '我是李天红', NULL, '2019-12-15 16:04:20'),
       (5, 'redsky',
        '在专辑《依然范特西》中，周杰伦表示会从旧歌中寻找新意，故《白色风车》便是周杰伦从之前的《黑色毛衣》得到的灵感而创作的出的歌曲。虽然两首歌的歌词都出自周杰伦的手笔，但周杰伦表示后面的创作的《白色风车》难写。周杰伦享用2这首歌来告诉大家，爱情是一种梦幻又真实的，甜蜜而忧伤的复杂情怀。',
        NULL, '2019-12-18 15:10:46'),
       (12, 'Binyan', '《时光机》是周杰伦演唱的一首歌曲，由方文shan作词，收录在周杰伦发行的第九张个人专辑《魔杰座》中，2008年，《时光机》这首歌被选为“2008风尚大典”的主题曲。', NULL,
        '2019-12-18 16:49:43'),
...
INSERT INTO `userinfo` (`user_nickname`, `user_password`, `user_icon`)
VALUES ('redsky', '170405', NULL),
       ('Binyan', '170402', NULL);
COMMIT;
